            ...
            <div class="font-sans text-lg text-center">
                ...
                <div class="flex items-center justify-center p-2 gap-8">
                    <div class="flex flex-cols gap-8">
                        ...
                        @component('components.card', [
                            ...
                            'title' =>
                                '𝐃𝐎𝐒𝐓 𝐭𝐮𝐫𝐧𝐬 𝐨𝐯𝐞𝐫 𝐂𝐚𝐬𝐬𝐚𝐯𝐚 𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠 𝐅𝐚𝐜𝐢𝐥𝐢𝐭𝐲, 𝐬𝐩𝐚𝐫𝐤𝐬 𝐬𝐨𝐜𝐢𝐨𝐞𝐜𝐨𝐧𝐨𝐦𝐢𝐜 𝐠𝐫𝐨𝐰𝐭𝐡 𝐢𝐧 𝐜𝐨𝐧𝐟𝐥𝐢𝐜𝐭-𝐚𝐟𝐟𝐞𝐜𝐭𝐞𝐝 𝐜𝐨𝐦𝐦𝐮𝐧𝐢𝐭𝐲',
                            'program' => '#GIA',
                        ])
                        @endcomponent
                        {{-- second gia featured --}}
                        @component('components.card', [
                            ...
                            'link' => 'https://bit.ly/44VPcb5',
                            'title' => '𝐃𝐎𝐒𝐓-𝐒𝐃𝐍 𝐟𝐨𝐫𝐠𝐞𝐬 𝐌𝐎𝐀 𝐰𝐢𝐭𝐡 𝐋𝐆𝐔-𝐌𝐚𝐢𝐧𝐢𝐭 𝐭𝐨 𝐩𝐫𝐨𝐦𝐨𝐭𝐞 𝐢𝐧𝐝𝐢𝐠𝐞𝐧𝐨𝐮𝐬 𝐝𝐞𝐥𝐢𝐜𝐚𝐜𝐢𝐞𝐬 𝐭𝐡𝐫𝐨𝐮𝐠𝐡 𝐢𝐧𝐧𝐨𝐯𝐚𝐭𝐢𝐯𝐞 𝐭𝐞𝐜𝐡𝐧𝐨𝐥𝐨𝐠𝐢𝐞𝐬',
                            'program' => '#GIA',
                        ])
                        @endcomponent
                        {{-- third gia featured --}}
                ...
                <div class="flex items-center justify-center p-2 gap-8">
                    ...
                    @component('components.card', [
                        ...
                        'title' =>
                            '𝐃𝐎𝐒𝐓 𝐨𝐫𝐠𝐚𝐧𝐢𝐳𝐞𝐬 𝐑𝐞𝐬𝐞𝐚𝐫𝐜𝐡, 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐦𝐞𝐧𝐭, 𝐚𝐧𝐝 𝐄𝐱𝐭𝐞𝐧𝐬𝐢𝐨𝐧 𝐂𝐨𝐧𝐬𝐮𝐥𝐭𝐚𝐭𝐢𝐨𝐧 𝐂𝐚𝐫𝐚𝐯𝐚𝐧 𝐚𝐭 𝐒𝐮𝐫𝐢𝐠𝐚𝐨 𝐝𝐞𝐥 𝐍𝐨𝐫𝐭𝐞 𝐒𝐭𝐚𝐭𝐞 𝐔𝐧𝐢𝐯𝐞𝐫𝐬𝐢𝐭𝐲',
                        'program' => '#RND',
                    ])
                    @endcomponent
                    {{-- second rnd --}}
                    ...
                    {{-- third rnd --}}
                    @component('components.card', [
                        'location' => '/img/rnd2.jpg',
                        'link' => 'https://tinyurl.com/2mranr4p',
                        'title' => '𝐉𝐂𝐈 𝐒𝐮𝐫𝐢𝐠𝐚𝐨 𝐍𝐢𝐜𝐤𝐞𝐥 𝐩𝐚𝐫𝐭𝐧𝐞𝐫𝐬 𝐰𝐢𝐭𝐡 𝐃𝐎𝐒𝐓 𝐭𝐨 𝐞𝐦𝐩𝐨𝐰𝐞𝐫 𝐲𝐨𝐮𝐧𝐠 𝐦𝐢𝐧𝐝𝐬 𝐢𝐧 𝐒𝐮𝐫𝐢𝐠𝐚𝐨 𝐂𝐢𝐭𝐲 𝐨𝐧 𝐚𝐫𝐝𝐮𝐢𝐧𝐨 𝐚𝐧𝐝 𝐫𝐨𝐛𝐨𝐭𝐢𝐜𝐬',
                        'program' => '#RND',
                    ])
                    @endcomponent
                </div>
